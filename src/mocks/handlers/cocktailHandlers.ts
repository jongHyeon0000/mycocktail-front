...
const cocktailFullData = [
  {
    ...
    hashtags: [
      { cocktailHashtagId: 1, cocktailHashtag: "모히토" },
      { cocktailHashtagId: 2, cocktailHashtag: "쿠바" },
      { cocktailHashtagId: 3, cocktailHashtag: "민트" },
      { cocktailHashtagId: 4, cocktailHashtag: "상쾌한" },
      { cocktailHashtagId: 5, cocktailHashtag: "여름칵테일" },
      { cocktailHashtagId: 6, cocktailHashtag: "럼베이스" },
      { cocktailHashtagId: 7, cocktailHashtag: "클래식" },
    ],
    viewCount: 542,
    likeCount: 127,
    shareCount: 45,
    comments: [
      {
        ...
        replies: [
          ...
          },
          {
            ...
            cocktailId: 1,
            parentCommentId: 1,
            content: '나두 처음엔 너무 세게 눌렀다가 실패해써ㅎㅎ',
            depth: 1,
            isChildComment: true,
            sortOrder: 2,
  ...
  },
  {
    ...
    hashtags: [
      { cocktailHashtagId: 8, cocktailHashtag: "마가리타" },
      { cocktailHashtagId: 9, cocktailHashtag: "데킬라" },
      { cocktailHashtagId: 10, cocktailHashtag: "멕시코" },
      { cocktailHashtagId: 11, cocktailHashtag: "소금림" },
      { cocktailHashtagId: 12, cocktailHashtag: "상큼한" },
    ],
    viewCount: 381,
    likeCount: 89,
    shareCount: 32,
  ...
  },
  {
    ...
    hashtags: [
      { cocktailHashtagId: 13, cocktailHashtag: "올드패션드" },
      { cocktailHashtagId: 14, cocktailHashtag: "위스키" },
      { cocktailHashtagId: 15, cocktailHashtag: "클래식" },
      { cocktailHashtagId: 16, cocktailHashtag: "버번" },
      { cocktailHashtagId: 17, cocktailHashtag: "깊은맛" },
    ],
    viewCount: 897,
    likeCount: 203,
    shareCount: 67,
  ...
  },
  {
    ...
    hashtags: [
      { cocktailHashtagId: 18, cocktailHashtag: "롱아일랜드아이스티" },
      { cocktailHashtagId: 19, cocktailHashtag: "5종기주" },
      { cocktailHashtagId: 20, cocktailHashtag: "파티칵테일" },
      { cocktailHashtagId: 21, cocktailHashtag: "강한칵테일" },
      { cocktailHashtagId: 22, cocktailHashtag: "클래식" },
    ],
    viewCount: 834,
    likeCount: 201,
    shareCount: 87,
  ...
  },
  {
    ...
    hashtags: [
      { cocktailHashtagId: 23, cocktailHashtag: "위스키사워" },
      { cocktailHashtagId: 24, cocktailHashtag: "상큼한" },
      { cocktailHashtagId: 25, cocktailHashtag: "레몬" },
      { cocktailHashtagId: 26, cocktailHashtag: "클래식" },
      { cocktailHashtagId: 27, cocktailHashtag: "사워계열" },
    ],
    viewCount: 298,
    likeCount: 74,
    shareCount: 28,
  ...
  },
  {
    ...
    hashtags: [
      { cocktailHashtagId: 28, cocktailHashtag: "에스프레소마티니" },
      { cocktailHashtagId: 29, cocktailHashtag: "커피" },
      { cocktailHashtagId: 30, cocktailHashtag: "보드카" },
      { cocktailHashtagId: 31, cocktailHashtag: "모던클래식" },
      { cocktailHashtagId: 32, cocktailHashtag: "카페인" },
    ],
    viewCount: 412,
    likeCount: 92,
    shareCount: 35,
