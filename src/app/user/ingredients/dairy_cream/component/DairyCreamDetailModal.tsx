...
interface DairyCreamDetailModalProps {
  open: boolean;
  onClose: () => void;
  data: DairyCreamDetail;
}

const DairyCreamDetailModal: React.FC<DairyCreamDetailModalProps> = ({ open, onClose, data }) => {
        ...
        <StyledModal open={open} onClose={onClose} closeAfterTransition>
          ...
          >
            <HeaderSection>
              <IngredientImage>
                {data.image ? (
                  <img src={data.image} alt={data.dairyCreamName} />
                ) : (
                  <PlaceholderIcon>
              ...
              <TitleSection>
                <EnglishTitle>{data.dairyCreamName}</EnglishTitle>
                <KoreanTitle>{data.dairyCreamNameKr}</KoreanTitle>
              </TitleSection>
...
export default DairyCreamDetailModal;
