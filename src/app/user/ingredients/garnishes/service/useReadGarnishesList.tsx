...
const useReadGarnishesList = () => {
  ...
  const fetchReadGarnishesList = async (params?: FetchProps, appendData = false) => {
    ...
    try{
      const response = await api.get<ApiResponse<GarnishesDetail[]>>(`/api/garnishes`, { params });
  ...
  return {
    garnishesList: data,
    garnishesListLoading: loading,
    garnishesListLoadingMore: loadingMore,
    garnishesListError: error,
    garnishesListHasMore: hasMore,
    fetchReadGarnishesList
  };
}

export default useReadGarnishesList;