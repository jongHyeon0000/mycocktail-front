...
import { getPrimaryFunctionKorean } from "../common/GarnishesUtils.ts";
...
interface GarnishesDetailModalProps {
  open: boolean;
  onClose: () => void;
  data: GarnishesDetail;
}

const GarnishesDetailModal: React.FC<GarnishesDetailModalProps> = ({ open, onClose, data }) => {
        ...
        <StyledModal open={open} onClose={onClose} closeAfterTransition>
          ...
          >
            <HeaderSection>
              <IngredientImage>
                {data.image ? (
                  <img src={data.image} alt={data.garnishName} />
                ) : (
                  <PlaceholderIcon>
              ...
              <TitleSection>
                <EnglishTitle>{data.garnishName}</EnglishTitle>
                <KoreanTitle>{data.garnishNameKr}</KoreanTitle>
              </TitleSection>
              ...
              <InfoGrid>
                ...
                <InfoCard>
                  <InfoLabel>주요 사용처</InfoLabel>
                  <CategoryChip label={getPrimaryFunctionKorean(data.primaryFunction)} size="small" />
                </InfoCard>
              </InfoGrid>
            </HeaderSection>
...
export default GarnishesDetailModal;
