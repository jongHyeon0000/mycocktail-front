...
const useReadOtherIngredientsList = () => {
  ...
  const fetchReadOtherIngredientsList = async (params?: FetchProps, appendData = false) => {
    ...
    try{
      const response = await api.get<ApiResponse<OtherIngredientsDetail[]>>(`/api/other-ingredients`, { params });
  ...
  return {
    otherIngredientsList: data,
    otherIngredientsListLoading: loading,
    otherIngredientsListLoadingMore: loadingMore,
    otherIngredientsListError: error,
    otherIngredientsListHasMore: hasMore,
    fetchReadOtherIngredientsList
  };
}

export default useReadOtherIngredientsList;