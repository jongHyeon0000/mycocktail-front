...
interface OtherIngredientsDetailModalProps {
  open: boolean;
  onClose: () => void;
  data: OtherIngredientsDetail;
}

const OtherIngredientsDetailModal: React.FC<OtherIngredientsDetailModalProps> = ({ open, onClose, data }) => {
        ...
        <StyledModal open={open} onClose={onClose} closeAfterTransition>
          ...
          >
            <HeaderSection>
              <IngredientImage>
                {data.image ? (
                  <img src={data.image} alt={data.otherIngredientName} />
                ) : (
                  <PlaceholderIcon>
              ...
              <TitleSection>
                <EnglishTitle>{data.otherIngredientName}</EnglishTitle>
                <KoreanTitle>{data.otherIngredientNameKr}</KoreanTitle>
              </TitleSection>
...
export default OtherIngredientsDetailModal;
