...
const useReadSyrupList = () => {
  ...
  const fetchReadSyrupList = async (params?: FetchProps, appendData = false) => {
    ...
    try{
      const response = await api.get<ApiResponse<SyrupDetail[]>>(`/api/syrup`, { params });
  ...
  return {
    syrupList: data,
    syrupListLoading: loading,
    syrupListLoadingMore: loadingMore,
    syrupListError: error,
    syrupListHasMore: hasMore,
    fetchReadSyrupList
  };
}

export default useReadSyrupList;