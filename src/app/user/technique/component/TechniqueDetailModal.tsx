...
import {
  ...
  getTechniqueCategoryKorean,
  getTemperatureChangeKorean,
...
const TechniqueDetailModal: React.FC<TechniqueDetailModalProps> = ({ open, onClose, data }) => {
...
const TechniqueImage = styled(Box)`
  && {
    width: 320px;
    height: 320px;
    border-radius: 20px;
