...
const useReadGlasswareList = () => {
  ...
  const fetchReadGlasswareList = async (params?: FetchProps, appendData = false) => {
    ...
    try{
      const response = await api.get<ApiResponse<GlasswareDetail[]>>(`/api/glassware`, { params });
  ...
  return {
    glasswareList: data,
    glasswareListLoading: loading,
    glasswareListLoadingMore: loadingMore,
    glasswareListError: error,
    glasswareListHasMore: hasMore,
    fetchReadGlasswareList
  };
}

export default useReadGlasswareList;