...
const useReadMyComments = () => {
  ...
  const fetchReadMyComments = async (params?: FetchProps, appendData = false) => {
    ...
    try {
      ...
      const res = await api.get<ApiResponse<UserComment[]>>(`/api/user/${userId}/comments`, { params: queryParams });
  ...
  return {
    ...
    commentListLoading: loading,
    commentListLoadingMore: loadingMore,
    commentListHasMore: hasMore,
    fetchReadMyComments
  };
}

export default useReadMyComments;
